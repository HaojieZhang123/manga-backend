...
public class SecurityConfiguration {
    ...
    SecurityFilterChain filterChain(HttpSecurity http)
        ...
        http.authorizeHttpRequests(requests -> requests
                ...
                .requestMatchers(HttpMethod.PUT, "/manga/**").hasAuthority("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/manga/**").hasAuthority("ADMIN")
                .requestMatchers(HttpMethod.POST, "/authors/**").hasAuthority("ADMIN")
                .requestMatchers(HttpMethod.PUT, "/authors/**").hasAuthority("ADMIN")
                ...
                .requestMatchers(HttpMethod.POST, "/status/**").hasAuthority("ADMIN")
                .requestMatchers(HttpMethod.PUT, "/status/**").hasAuthority("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/status/**").hasAuthority("ADMIN")
